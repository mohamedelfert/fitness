...
- Generation: Program ✅ (`FR-AI-001`), MealPlan ✅ (`FR-AI-002`), exercise alternatives ✅ (`FR-AI-003`, cheap-tier, `POST /v1/ai/exercise-alternatives` — safe swaps, no persist), daily recommendation (`FR-AI-004`) ⬜, conversational coach (`FR-AI-008`) ⬜, plan-adjustment proposals (`FR-AI-006`) ⬜.
